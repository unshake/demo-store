...
import jwt, datetime, re, psycopg2
...
@application.route('/api/v0/login/', methods=['GET', 'POST'])
def userLogIn():
...
@application.route('/api/v0/logout/<string:logOutToken>')
...
@application.route('/api/v0/products/add/<string:uToken>', methods=['GET', 'POST'])
...
@application.route('/api/v0/register/', methods=['GET', 'POST'])
def userRegister():
	if request.method == 'POST':
...
@application.route('/api/v0/products/cart/')
def addToCart():
	return "To be implemented"

@application.route('/api/v0/users/show/')
def showUsers():
	allUsers = session.query(Users)
	return jsonify(Users=[u.serialize for u in allUsers])

@application.route('/api/v0/users/recovery/', methods=['GET', 'POST'])
